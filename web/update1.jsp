            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">BATCH UPDATE</h1>
                        <!-- Content Row -->
                        <div class="row">
                                    ...
                                    <div class="card-body text-left">
                                        <%
                                            try {
                                                connection = DriverManager.getConnection(connectionUrl + database, userid, password);
                                                statement = connection.createStatement();
                                                String sql = "select * from batch_details where btid=" + btid;
                                                resultSet = statement.executeQuery(sql);
                                                while (resultSet.next()) {
                                        %>
                                        <form action="update-process1.jsp" method="post" name="myform1">
                                            <div class="row">
                                                <div class="col">    
                                                    Batch Id:
                                                </div>
                                                <div class="col">
                                                    <input class="form-control" value="<%=resultSet.getString("btid")%>" type="text" name="btid" />
                                                </div>
                                            </div><br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input type="text" class="form-control" value="<%=resultSet.getString("btsub")%>" name="btsub"/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input type="text" class="form-control" name="btfal" value="<%=resultSet.getString("btfal")%>"/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" value="<%=resultSet.getString("btstart")%>" type="date" name="btstart"/>
                                                </div>
                                            </div> <br/>     
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" value="<%=resultSet.getString("btend")%>" type="date" name="btend"/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input type="text" class="form-control" name="btlec" value="<%=resultSet.getString("btlec")%>"/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
