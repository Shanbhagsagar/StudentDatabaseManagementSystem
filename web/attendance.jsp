            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Student Attendance</h1>
                        <!-- Content Row -->
                        <div class="row">
                                    ...
                                    <div class="card-body text-left">
                                        <%
                                            try {
                                                connection = DriverManager.getConnection(connectionUrl + database, userid, password);
                                                statement = connection.createStatement();
                                                String sql1 = "select * from student_batch_details as SB join student_details as SD on SB.stid=SD.stid join batch_details as BD on SB.btid=BD.btid where SB.btid=" + btid;
                                               
                                               
                                                resultSet = statement.executeQuery(sql1);
                                              resultSet.next();
                                        %>
                                        <form action="attendprocess.jsp" method="post">
                                            <div class="row">
                                                <div class="col">    
                                                    Batch id:
                                                </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" name="btid" value="<%=resultSet.getString("btid")%>" readonly/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">   
                                                    <input  type="date" class="form-control"  min="<%=resultSet.getString("btstart")%>" max="<%=resultSet.getString("btend")%>"  name="atdate" required/>
                                                </div>
                                            </div> <br/>   
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input type="text" class="form-control" name="atin" required/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input type="text" class="form-control" name="atout" required/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
