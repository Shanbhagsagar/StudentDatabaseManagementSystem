                ...
                <li class="nav-item  active">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="queries.jsp">Queries/Complaint</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Query/Issue</h1>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form action="queryask" method="post">
                                            <div class="form-group">
                                                <input type="hidden" class="form-control" name="stid" value="<%=resultSet.getString("stid")%>">
                                                <label class="display-4">Query</label>
                                                <input type="date" class="form-control" name="date" required>
                                                <small id="emailHelp" class="form-text text-muted">The date from when you are facing the issue</small>
                                            </div><br>
                                            <div class="form-group">
                                                <label class="display-4">Issue Elaboration</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="issue" required></textarea>
                                            </div>
