                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="theorybook.jsp">Theory Exam Booking</a>
                        </div>
                    </div>
                </li>
                <!--Download nav -->
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Theory Exam Booking</h1>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card shadow mb-3">
                                    ...
                                    %>
                                    <div class="card-body">
                                        <form method="post" action="theorybook">
                                            <ul class="list-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" value="Theory" name="exmode" readonly>
                                                </div><br>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
