                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="exam.jsp">Exam Details</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger text-center font-weight-bold">Examination Details</h1>
                        <div class="row">
                            <div class="col-lg-3"></div>
                            <div class="col-lg-6">
                                <!-- Exam Practiceal -->
                                <div class="card shadow mb-3">
                                    <div class="card-header display-4 text-danger">Practical Exam Details</div>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <%
                                                    try {
                                                        connection = DriverManager.getConnection(connectionUrl + database, userid, password);
                                                        statement = connection.createStatement();
                                                        String sql = "select * from exam where exmode='Practical' and stid=" + session.getAttribute("userid");
                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-header display-4 text-danger">Theory Exam Details</div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <thead class="thead-light">
                                                ...
                                                <% String sql1 = "select * from exam where exmode='Theory' and stid=" + session.getAttribute("userid");
                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <span class="m-0 text-warning display-4 ">Note:</span>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">Refer below Marks Color Notation as per Individual Marks Percentage </li>
                                            <li class="list-group-item">Below 40% : <button type="button" class="btn btn-outline-danger">Red</button></li>
                                            <li class="list-group-item">Above 40% : <button type="button" class="btn btn-outline-success">Green</button></li>
                                        </ul>
                                    </div>
                                </div> 
                            </div>
