            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Delete Student</h1>
                        <!-- Content Row -->
                        <div class="row">
                                    ...
                                    <div class="card-body text-left">
                                        <%
                                            try {
                                                ...
                                                while (resultSet.next()) {
                                        %>
                                        <form action="delete1.jsp" method="post" name="myform1">
                                            <div class="row">
                                                <div class="col">    
                                                    Batch Id:
                                                </div>
                                                <div class="col">
                                                    <input class="form-control" value="<%=resultSet.getInt("btid")%>" type="text" name="btid" readonly/>
                                                </div>
                                            </div><br/>
                                            ...
                                            <div class="row">
                                                <div class="col">    
                                                    <center><input type="Submit" value="Delete Student" class="b1"/></center>
                                                </div>
                                            </div> <br/>
                                        </form>          
                                    </div>
