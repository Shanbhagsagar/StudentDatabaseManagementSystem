...
<%
    ...
    if (session.getAttribute("adid") == null) {
        ...
        out.println("</script>");
        out.println("<html><meta http-equiv='refresh' content='1;url=http://localhost:8084/angelos/adminlogin.jsp'/></html>");
    }
%>
<%
    try {
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Add Student</h1>
                        <!-- Content Row -->
                        <div class="row">
                                    ...
                                    <div class="card-body text-left">
                                        <%
                                            try {
                                                ...
                                                while (resultSet.next()) {
                                        %>
                                        <form action="add1.jsp" method="post" name="myform1">
                                            <div class="row">
                                                <div class="col">    
                                                    Batch Id:
                                                </div>
                                                <div class="col">
                                                    <input class="form-control" value="<%=resultSet.getString("btid")%>" type="text" name="btid" readonly/>
                                                </div>
                                            </div><br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">
                                                    <input class="form-control" type="text" name="stid" />
                                                </div>
                                            </div><br/>
                                            
                                            <div class="row">
                                                <div class="col">    
                                                    <center><input type="Submit" value="Add Student" class="b1"/></center>
                                                </div>
                                            </div> <br/>
                                        </form>          
                                    </div>
