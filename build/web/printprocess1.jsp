...
<%
    ...
    try {
        ...
        String file_name = "F:\\" + stid +"-"+id+" Fees Recpt.pdf";
       ...
       String img_name = "D:\\project\\angelos\\web\\pic\\logo.jpg";
        ...
        String sql = "select * from fees as f join student_details as SD on f.stid=SD.stid where f.stid=" + stid;
        resultSet = pstmt.executeQuery(sql);
        resultSet.next();
        Paragraph para1 = new Paragraph("Fees Report of " +resultSet.getString("stname"));
