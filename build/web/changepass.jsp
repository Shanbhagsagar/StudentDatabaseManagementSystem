...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">Change Password</h1>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-3">
                                    <div class="card-body">
                                        <form class="pure-form" name="f2" onsubmit="return matchpass2();" method="post" action="passchange.jsp">
                                            <div class="form-group">
                                                <input type="hidden" name="stid" class="form-control" value="<%=session.getAttribute("userid")%>">
                                            </div>
                                            <div class="form-group">
                                                <label>New Passsword</label>
                                                <input type="password" name="pass1" class="form-control" id="psw"  required>
                                            </div>
                                            <div class="form-group">
                                                <label>Re-enter Password</label>
                                                <input type="password" name="pass2" class="form-control" id="confirm_psw" required>
                                            </div>
                                            <div class="d-flex justify-content-center"><button type="submit" class="btn btn-lg btn-danger " onClick="validatePassword()">Submit</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
        ...
        <script lang="javascript">
                                                ...
                                                function matchpass2() {
                                                    var pass1 = document.f2.pass1.value;
                                                    var pass2 = document.f2.pass2.value;
