                ...
                <li class="nav-item">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="batchcreation.jsp">Create</a>
                        </div>
                    </div>
                </li>
                <!-- Divider -->
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-danger font-weight-bold text-center">BATCH CREATION</h1>
                        <!-- Content Row -->
                        <div class="row">
                            ...
                            <div class="col-lg-6">   
                                ...
                                <div class="card shadow mb-2">
                                    <div class="card-header card1">
                                        <div class="text-left text-link text-danger"><h3>Batch Creation:</h3></div>    
                                    </div>
                                    <div class="card-body text-left">
                                        <form action="batch_detail" method="post">
                                            <div class="row">
                                                <div class="col">    
                                                    Subject:
                                                </div>
                                                <div class="col">   
                                                    <input class="form-control" type="text" name="btsub" required/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" type="text" name="btfal" required/>
                                                </div>
                                            </div> <br/>
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" type="date" id="datefield" min="" max="" name="btstart" required/>
                                                </div>
                                            </div> <br/>      
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" id="datefield1" min="" max="" type="date" name="btend" required/>
                                                </div>
                                            </div> <br/>      
                                            <div class="row">
                                                <div class="col">    
                                                ...
                                                <div class="col">   
                                                    <input class="form-control" type="text" name="btlec" required/>
                                                </div>
                                            </div> <br/>     
                                            <div class="row">
                                                <div class="col">    
